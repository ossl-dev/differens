...
Two versions of a Go package — a method extracted to a new function:
...
```
method ValidateEmail: replaced body with call to validateEmail
extracted function validateEmail from method ValidateEmail
```
